...
let dayOfWeek = Number(prompt("Enter the day of week") ?? 0);
switch (dayOfWeek) {
    case 1:
        console.log('Monday');
        break;
...
let firstNum = Number(prompt("Enter the first number") ?? 0);
let secondNum = Number(prompt("Enter the second number") ?? 0);
